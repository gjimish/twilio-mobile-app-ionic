...
/// Register to receive remote notifications via Apple Push Notification service.
/// \param options A bit mask specifying the types of notifications the app accepts. See <a href="https://developer.apple.com/documentation/appkit/nsapplication.remotenotificationtype">NSApplication.RemoteNotificationType</a> for valid bit-mask values.
///
- (void)registerForRemoteNotificationsWithOptions:(NSRemoteNotificationType)options;
/// Set user id.
